...
// impl ToStyledLine for TextInputFields {
//     fn to_styled_line<'a>(
//         &self,
//         label: Option<&'a str>,
//         value: Option<&'a str>,
...
//             .add_modifier(Modifier::BOLD);
//         let normal_style: Style = Style::default().fg(Color::Rgb(164, 176, 190));
//         let is_focused = app_state.focus == self.value();
//         let style = if is_focused {
//             focused_style
//         } else {
//             normal_style
...
//         Line::from(vec![
//             Span::styled(if is_focused { "> " } else { "  " }, style),
//             Span::styled(label.unwrap().to_string(), style),
//             Span::raw(value.unwrap().to_string()),
//         ])
//     }
// }
// impl ToStyledLine for ToggleOption {
//     fn to_styled_line<'a>(
//         &self,
//         _label: Option<&'a str>,
//         _value: Option<&'a str>,
...
//             normal_style
//         };
//         Line::from(self.set_user_option(app_state)).style(style)
//     }
// }
